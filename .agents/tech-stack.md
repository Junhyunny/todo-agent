...
## Frontend — `frontend/`
- **언어/프레임워크:** TypeScript + React + React Router + Electron + Tailwind v4 + shadcn/ui + @base-ui/react
...
## Backend — `backend/`
- **언어/프레임워크:** Python + FastAPI + SQLAlchemy + SQLite + Alembic + LangChain/LangGraph
- **빌드:** pip
- **린트/타입체크:** ruff + mypy (strict)

...
- 이 경우 프로젝트 파일을 다시 검색하거나 `/sync-tech-stack`를 자동 호출하지 않습니다
...
- **현재 태스크가 `✅ done`으로 끝난 뒤** 다음 태스크 또는 `/tdd-commit`으로 넘어가기 전에 필요하면 `/context`와 `/compact`를 사용할 수 있다고 **간단히 안내**합니다

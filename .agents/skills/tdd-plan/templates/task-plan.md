...
Phase 2(협업 계획) 종료 시 생성됩니다. 초기 태스크 분류를 제시할 때 전체를 표시하고, 이후 수정 시에는 변경된 항목만 표시하세요.
...
- After revisions, show only changed tasks/questions unless the developer asks for the full plan again
```
